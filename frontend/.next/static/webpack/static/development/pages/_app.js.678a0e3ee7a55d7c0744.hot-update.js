...
var CartItem = function CartItem(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(CartItemStyles, {
    ...
    __self: this
  }, cartItem.quantity, " \xD7 ", Object(_lib_formatMoney__WEBPACK_IMPORTED_MODULE_3__["default"])(cartItem.item.price), " each")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(RemoveCartItem, {
    id: cartItem.id,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34
...
var REMOVE_ITEM_MUTATION = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject());
...
function (_Component) {
  ...
  function RemoveFromCart() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      data.me.cart = data.me.cart.filter(function (el) {
        return el.id !== payload.data.removeFromCart.id;
...
//# sourceMappingURL=_app.js.678a0e3ee7a55d7c0744.hot-update.js.map